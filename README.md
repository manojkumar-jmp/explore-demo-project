...
### A simple “Book Library” web application where users can:
...
**Where?**  
- `BookLibrary.IntegrationTests` project (with SpecFlow NuGet).
...
**Where?**  
- `BookLibrary.UITests` (UI test folder).
